...
import { resolveActiveStorePost } from '@/lib/multitenancy/session-store-hydrate'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { allowed, storeRole } = await resolveActiveStorePost(uid, oid, {
      storeAlreadyVerifiedActive: true
    })
