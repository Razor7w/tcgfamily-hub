...
import { buildPlayerSeasonRounds } from '@/lib/player-season-summary'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const payload = await buildPlayerSeasonRounds(
      session.user.id,
      uid,
      period,
      origin
    ...
    console.error('GET /api/events/my-season-rounds:', error)
