...
function readPokemonSubtype(
  v: unknown
): PokemonTournamentSubtype | null | undefined {
        ...
        if (raw === null || raw === '') {
          ...
          if (!Number.isFinite(n) || n < 0 || n > 99) {
            return NextResponse.json(
              {
                error:
                  'Tope de ronda dashboard: número entre 0 y 99 (0 = sin tope)'
              },
              { status: 400 }
            )
          }
