                        ...
                        <TableRow>
                          <TableCell colSpan={4}>
                            <Typography
                              ...
                              sx={{ py: 2 }}
                            >
                              Aún no hay puntos: asigna torneos cerrados a esta
                              liga y asegúrate de que los participantes tengan
                              récord W/L/T en el evento.
                            </Typography>
                          </TableCell>
                        </TableRow>
                      ) : (
                            ...
                            {row.events.map(ev => (
                              ...
                              >
                                ...
                                {ev.leagueRoundBasis != null
                                  ...
                                  : ''}{' '}
                                · {ev.wins}-{ev.losses}-{ev.ties} ({ev.points}{' '}
                                pts)
                              </Typography>
                            ))}
                          </Stack>
