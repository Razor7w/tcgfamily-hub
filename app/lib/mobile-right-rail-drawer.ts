...
export const MOBILE_RIGHT_RAIL_DRAWER_OPEN = 'tcgnexo:mobile-right-rail-drawer-open'
export const MOBILE_RIGHT_RAIL_DRAWER_CLOSE = 'tcgnexo:mobile-right-rail-drawer-close'
