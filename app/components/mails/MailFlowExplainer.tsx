  ...
  return (
    <>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 1.5 }}>
        Así encajan los pasos con lo que ves en la tabla (columna{' '}
        <strong>Estado</strong> y el icono del código junto a cada correo).
      </Typography>
      ...
      <Typography
        ...
        sx={{ mt: 1, mb: 0 }}
      >
        Resumen de estados: <strong>No recibido en tienda</strong> →{' '}
        <strong>En tienda</strong> → <strong>Retirado</strong>.
      </Typography>
    </>
  )
}
        ...
        >
          ...
          <Box sx={{ display: { xs: 'none', sm: 'block' } }}>
            <Typography variant="body2" color="text.secondary" component="div">
              El <strong>emisor</strong> lo registra aquí y obtiene un{' '}
              <strong>código</strong> (también en código de barras). Llevas el{' '}
              <strong>envío a la tienda</strong>; cuando ellos confirman el
              ingreso, el estado pasa a <strong>En tienda</strong>. Para{' '}
              <strong>solicitar o retirar</strong> el paquete en tienda se usa{' '}
              <strong>el mismo código</strong>. Al cerrarse el retiro verás{' '}
          ...
          <Box sx={{ display: { xs: 'block', sm: 'none' } }}>
            ...
            >
              Código único, envío a tienda y retiro con el mismo código. El
              detalle completo va en un toque.
            </Typography>
            <Button
              variant="outlined"
              size="small"
