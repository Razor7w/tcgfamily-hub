...
function buildGameResultsForSave(
  rows: GameRowState[]
): GameResultLetter[] | null {
...
export default function TournamentMatchRoundsCard({
  ...
  const showOfficialRecord =
    !isCustomTournament && eventState === 'close' && officialMatchRecord != null
    ...
    <>
      ...
      >
        ...
        >
          <Stack spacing={{ xs: 2, sm: 2.25 }}>
            ...
            !isCustomTournament ? (
              ...
              >
                Si no ves tu puesto, revisa que tu POP ID coincida con el del
                torneo importado.
              </Typography>
            ) : null}
          </Stack>
        ...
        <Box sx={{ px: { xs: 2, sm: 3 }, py: { xs: 2, sm: 2.5 } }}>
          ...
          {showOfficialRecord ? (
            ...
            >
              Lo que guardes en esta tabla es solo tu bitácora; no sustituye el
              récord oficial del torneo (arriba).
            </Typography>
          ) : null}
      ...
      {!readOnly ? (
        <Drawer
          ...
          slotProps={{
            backdrop: {
              sx: { backgroundColor: t => alpha(t.palette.common.black, 0.45) }
            }
          }}
          PaperProps={{
            sx: t => ({
