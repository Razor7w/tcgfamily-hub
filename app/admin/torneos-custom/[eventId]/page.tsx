      ...
      <Container maxWidth="lg" sx={{ px: { xs: 2, sm: 3 } }}>
        ...
        {isPending ? (
          ...
          <Alert severity="error" sx={{ mb: 2 }}>
            ...
            <Button sx={{ ml: 2 }} onClick={() => router.replace("/admin/torneos-custom")}>
              Ir al listado
            </Button>
          </Alert>
        ) : !ev ? null : !ev.adminReadOnlyView ? (
          <Alert severity="warning" sx={{ mb: 2 }}>
            Esta vista es solo para administradores revisando un torneo custom. Si llegaste aquí por
            error, vuelve al listado.
            <Button sx={{ ml: 2 }} component={Link} href="/admin/torneos-custom">
              Listado
            </Button>
          </Alert>
        ) : (
          <Stack spacing={{ xs: 2.25, sm: 3 }}>
            <Typography variant="body2" color="text.secondary">
              Vista de solo lectura: datos que reportó el creador en su torneo personal (no editable
              desde el panel).
            </Typography>
            ...
            (ev.myRegistration || ev.adminReadOnlyView) ? (
                    ...
                    <Stack direction="row" spacing={2} alignItems="flex-start">
                      ...
                      <Box>
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.5 }}>
                          Pokémon que el jugador eligió mostrar junto a su récord en «Mis torneos».
                        </Typography>
                      </Box>
                    </Stack>
              ...
              <Alert severity="info">
                Este evento no es un torneo Pokémon TCG o no hay participante asociado para mostrar
                el detalle.
              </Alert>
            )}
          </Stack>
