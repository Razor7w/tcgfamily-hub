...
La **versión canónica** del proyecto es la de `package.json` (`version`). Debe coincidir con la última entrada numerada de `CHANGELOG.md` cuando se publique un hito (actualmente **0.5.5**).
